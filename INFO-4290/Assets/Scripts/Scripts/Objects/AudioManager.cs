...
public class AudioManager : MonoBehaviour
{
    ...
    void Awake ()
    {
        ...
        if (currentScene.element == null || currentScene.element == "")
        {
            currentScene.element = GameObject.FindGameObjectWithTag("Player").scene.name;
        }
        currentTheme = currentScene.element;
        startLoop(currentScene.element + " Theme");
    ...
    public void changeVolumePitch(Sound s, float volume, float pitch)
    {
